...
public final class CountryAnswerPresenter {
    ...
    /// Presents a failure as a retryable bubble bound to the question that failed.
    @MainActor
    public func presentError(retrying question: String) {
        view.display(CountryAnswerViewModel(
            message: Self.localized("LOADING_FAILED_MESSAGE"),
